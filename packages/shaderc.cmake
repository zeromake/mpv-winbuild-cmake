...
ExternalProject_Add_Step(shaderc manual-install
    ...
    COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/libshaderc/libshaderc_shared.dll ${MINGW_INSTALL_PREFIX}/bin/libshaderc_shared.dll
    COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/libshaderc/libshaderc_shared.dll.a ${MINGW_INSTALL_PREFIX}/lib/libshaderc_shared.a
    COMMAND ${CMAKE_COMMAND} -E copy <BINARY_DIR>/shaderc.pc ${MINGW_INSTALL_PREFIX}/lib/pkgconfig/shaderc.pc
